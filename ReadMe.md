safetensors_schema.py [![Unlicensed work](https://raw.githubusercontent.com/unlicense/unlicense.org/master/static/favicon.png)](https://unlicense.org/)
==============
~~[wheel (GitLab)](https://gitlab.com/KOLANICH-libs/safetensors_schema.py/-/jobs/artifacts/master/raw/dist/safetensors_schema-0.CI-py3-none-any.whl?job=build)~~
...
~~![GitLab Build Status](https://gitlab.com/KOLANICH-libs/safetensors_schema.py/badges/master/pipeline.svg)~~
~~![GitLab Coverage](https://gitlab.com/KOLANICH-libs/safetensors_schema.py/badges/master/coverage.svg)~~
